...
<html>
  ...
  <head>
    <title> Manager Login | Ti'zazi Migibi </title>
...
<?php
        ...
        $sql = "SELECT * FROM restaurants WHERE M_ID = '".$login_session."'";
...
<?php
  ...
  echo "<br>";
  $restaurant_details = mysqli_fetch_assoc($result);
  echo "<h2> Restaurant Name: ".$restaurant_details['name']."</h2>";
  echo "<h2> Restaurant Email ID: ".$restaurant_details['email']."</h2>";
  echo "<h2> Restaurant Contact Number: ".$restaurant_details['contact']."</h2>";
  echo "<h2> Restaurant Address: ".$restaurant_details['address']."</h2>";
}
?>
        </div>
    </div>
