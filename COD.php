...
<h2 class="text-center"> Thank you for Ordering at Ti'zazi Migibi! The ordering process is now complete.</h2>
...
<h4 style="background-color: rgba(0, 0, 0, 0.3);border-radius: 100px;max-width: 200px; padding: 5px; text-align: center; margin: 0px auto"><a href="foodlist.php" style="padding:10px; color: black; text-decoration: none;">Back to Food Zone</a></h4>
        </body>
